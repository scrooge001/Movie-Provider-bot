...
# HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/scrooge010') 
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/scrooge010') # How to open tutorial link for verification
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/adgmovies')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+ZbkFFZkta7BlNTll')
TUTORIAL = environ.get('PROBLEMS', 'https://t.me/scrooge010') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', False))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ScroogeX')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/scrooge010') #Support group link ( make sure bot is admin )
...
LANGUAGES = ["english", "", "Sinhala", "", "Malay", ""]
